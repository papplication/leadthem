...
(function($){
	...
	$('.mailchimpForm').ajaxChimp({
		...
		url: "https://github.us1.list-manage.com/subscribe/post?u=337676ecab0ff8cda54074819&amp;id=f6547364d6" //Replace this with your own mailchimp post URL. Don't remove the "". Just paste the url inside "".  
	});
}(jQuery));